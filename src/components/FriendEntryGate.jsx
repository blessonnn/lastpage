...
const FriendEntryGate = ({ onBack, onEnter }) => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-4 bg-background paper-grain">
      ...
      >
        <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl text-ink mb-8 sm:mb-12 flex flex-wrap justify-center items-center gap-x-[0.2em]">
          {["What's", "your", "name?"].map((word, i) => (
        ...
        <form onSubmit={handleSubmit} className="space-y-8 sm:space-y-12">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            transition={{ 
              scaleX: { duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.4 },
